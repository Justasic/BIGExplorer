...
// This disables all retarded warnings for this file.
...
// Added this to make it useful for my project - Justasic
template<typename... Args>
std::string _(const std::string &fmt, const Args&... args)
{
	std::ostringstream oss;
	tinyformat::format(oss, fmt.c_str(), args...);
	return oss.str();
}
